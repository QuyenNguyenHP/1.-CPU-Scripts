...
### 8.2 🚀 Reload, enable, and start all services
...
### 8.3 ✅ Check all service statuses

```bash
systemctl status modbus.service zip_csv_files.service encrypt.service \
    send_asc_scp.service pulse.service hmi.service photo.service autossh-tunnel.service
```

### 8.4 📋 View latest 100 logs
