...
To update all scripts on the device to the latest version from the repository:
...
> ⚠️ This will discard any local changes. Make sure nothing important is uncommitted before running.
